...
export default class ImageBrowser extends React.Component {
    ...
    async componentDidMount() {
        ...
        const permission2 = await Permissions.getAsync(Permissions.MEDIA_LIBRARY);
        const permission3 = await Permissions.getAsync(Permissions.MEDIA_LIBRARY_WRITE_ONLY);

        if (permission1.status !== 'granted'&&permission1.status !== 'granted'&& permission3.status !== 'granted') {
